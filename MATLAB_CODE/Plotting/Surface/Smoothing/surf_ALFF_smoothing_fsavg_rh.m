...
% AUDITORY CORTEX
infile_AC_as = '/Users/mszkcn/BrainStates_Test/Surface/Analysis/Compare_Smoothing/ALFF/AC/allsubs-as-surf_ALFF-AC-rh-fsavg-smoothing-compare.txt';
...
infile_AC_ns = '/Users/mszkcn/BrainStates_Test/Surface/Analysis/Compare_Smoothing/ALFF/AC/allsubs-ns-surf_ALFF-AC-rh-fsavg-smoothing-compare.txt';
...
infile_AC_vs = '/Users/mszkcn/BrainStates_Test/Surface/Analysis/Compare_Smoothing/ALFF/AC/allsubs-vs-surf_ALFF-AC-rh-fsavg-smoothing-compare.txt';
...
% HESCHLS GYRUS
infile_HG_as = '/Users/mszkcn/BrainStates_Test/Surface/Analysis/Compare_Smoothing/ALFF/HG/allsubs-as-surf_ALFF-HG-rh-fsavg-smoothing-compare.txt';
...
infile_HG_ns = '/Users/mszkcn/BrainStates_Test/Surface/Analysis/Compare_Smoothing/ALFF/HG/allsubs-ns-surf_ALFF-HG-rh-fsavg-smoothing-compare.txt';
...
infile_HG_vs = '/Users/mszkcn/BrainStates_Test/Surface/Analysis/Compare_Smoothing/ALFF/HG/allsubs-vs-surf_ALFF-HG-rh-fsavg-smoothing-compare.txt';
...
% PLANUM TEMPORALE
infile_PT_as = '/Users/mszkcn/BrainStates_Test/Surface/Analysis/Compare_Smoothing/ALFF/PT/allsubs-as-surf_ALFF-PT-rh-fsavg-smoothing-compare.txt';
...
infile_PT_ns = '/Users/mszkcn/BrainStates_Test/Surface/Analysis/Compare_Smoothing/ALFF/PT/allsubs-ns-surf_ALFF-PT-rh-fsavg-smoothing-compare.txt';
...
infile_PT_vs = '/Users/mszkcn/BrainStates_Test/Surface/Analysis/Compare_Smoothing/ALFF/PT/allsubs-vs-surf_ALFF-PT-rh-fsavg-smoothing-compare.txt';
...
infile_V1_as = '/Users/mszkcn/BrainStates_Test/Surface/Analysis/Compare_Smoothing/ALFF/V1/allsubs-as-surf_ALFF-V1-rh-fsavg-smoothing-compare.txt';
...
infile_V1_ns = '/Users/mszkcn/BrainStates_Test/Surface/Analysis/Compare_Smoothing/ALFF/V1/allsubs-ns-surf_ALFF-V1-rh-fsavg-smoothing-compare.txt';
...
infile_V1_vs = '/Users/mszkcn/BrainStates_Test/Surface/Analysis/Compare_Smoothing/ALFF/V1/allsubs-vs-surf_ALFF-V1-rh-fsavg-smoothing-compare.txt';
...
lg = legend('show', {'ALFF', 'Smoothed ALFF'}, 'FontSize', 12);
lg.Layout.Tile = 'South'

sgtitle(['Comparing  ALFF and Smoothed ALFF on the Cortical Surface (fsaverage Right)'], 'FontSize', 20)
set(gcf,'position',[0 100 1000 800]);
saveas(cALFFfig, '/Users/mszkcn/BrainStates_Test/Surface/Graphs/Smoothed/allsubs-ALFF-smoothing-surf-rh-fsavg.m')
saveas(cALFFfig, '/Users/mszkcn/BrainStates_Test/Surface/Graphs/Smoothed/allsubs-ALFF-smoothing-surf-rh-fsavg.png')
