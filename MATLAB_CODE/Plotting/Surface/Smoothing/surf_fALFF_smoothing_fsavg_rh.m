...
% AUDITORY CORTEX
infile_AC_as = '/Users/mszkcn/BrainStates_Test/Surface/Analysis/Compare_Smoothing/fALFF/AC/allsubs-as-surf_fALFF-AC-rh-fsavg-smoothing-compare.txt';
...
infile_AC_ns = '/Users/mszkcn/BrainStates_Test/Surface/Analysis/Compare_Smoothing/fALFF/AC/allsubs-ns-surf_fALFF-AC-rh-fsavg-smoothing-compare.txt';
...
infile_AC_vs = '/Users/mszkcn/BrainStates_Test/Surface/Analysis/Compare_Smoothing/fALFF/AC/allsubs-vs-surf_fALFF-AC-rh-fsavg-smoothing-compare.txt';
...
% HESCHLS GYRUS
infile_HG_as = '/Users/mszkcn/BrainStates_Test/Surface/Analysis/Compare_Smoothing/fALFF/HG/allsubs-as-surf_fALFF-HG-rh-fsavg-smoothing-compare.txt';
...
infile_HG_ns = '/Users/mszkcn/BrainStates_Test/Surface/Analysis/Compare_Smoothing/fALFF/HG/allsubs-ns-surf_fALFF-HG-rh-fsavg-smoothing-compare.txt';
...
infile_HG_vs = '/Users/mszkcn/BrainStates_Test/Surface/Analysis/Compare_Smoothing/fALFF/HG/allsubs-vs-surf_fALFF-HG-rh-fsavg-smoothing-compare.txt';
...
% PLANUM TEMPORALE
infile_PT_as = '/Users/mszkcn/BrainStates_Test/Surface/Analysis/Compare_Smoothing/fALFF/PT/allsubs-as-surf_fALFF-PT-rh-fsavg-smoothing-compare.txt';
...
infile_PT_ns = '/Users/mszkcn/BrainStates_Test/Surface/Analysis/Compare_Smoothing/fALFF/PT/allsubs-ns-surf_fALFF-PT-rh-fsavg-smoothing-compare.txt';
...
infile_PT_vs = '/Users/mszkcn/BrainStates_Test/Surface/Analysis/Compare_Smoothing/fALFF/PT/allsubs-vs-surf_fALFF-PT-rh-fsavg-smoothing-compare.txt';
...
infile_V1_as = '/Users/mszkcn/BrainStates_Test/Surface/Analysis/Compare_Smoothing/fALFF/V1/allsubs-as-surf_fALFF-V1-rh-fsavg-smoothing-compare.txt';
...
infile_V1_ns = '/Users/mszkcn/BrainStates_Test/Surface/Analysis/Compare_Smoothing/fALFF/V1/allsubs-ns-surf_fALFF-V1-rh-fsavg-smoothing-compare.txt';
...
infile_V1_vs = '/Users/mszkcn/BrainStates_Test/Surface/Analysis/Compare_Smoothing/fALFF/V1/allsubs-vs-surf_fALFF-V1-rh-fsavg-smoothing-compare.txt';
...
sgtitle(['Comparing  fALFF and Smoothed fALFF on the Cortical Surface (fsaverage Right)'], 'FontSize', 20)
set(gcf,'position',[0 100 1000 800]);
saveas(cALFFfig, '/Users/mszkcn/BrainStates_Test/Surface/Graphs/Smoothed/allsubs-fALFF-smoothing-surf-rh-fsavg.m')
saveas(cALFFfig, '/Users/mszkcn/BrainStates_Test/Surface/Graphs/Smoothed/allsubs-fALFF-smoothing-surf-rh-fsavg.png')
