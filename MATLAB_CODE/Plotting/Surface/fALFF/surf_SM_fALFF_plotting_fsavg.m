...
sgtitle('Mean fALFF on the Cortical Surface (Smoothed) in each Brain Region (fsaverage Left) in Presence of Different Stimuli', 'FontSize', 15)
...
saveas(MeanALFFfig, '/Users/mszkcn/BrainStates_Test/Surface/Graphs/Smoothed/fALFF/MeanfALFF-surf-lh-SM-fsavg.png')
...
sgtitle('Mean fALFF on the Cortical Surface (Smoothed) in each Brain Region (fsaverage Right) in Presence of Different Stimuli', 'FontSize', 15)
set(gcf,'position',[0 100 1000 800]);
saveas(MeanALFFfig, '/Users/mszkcn/BrainStates_Test/Surface/Graphs/Smoothed/fALFF/MeanfALFF-surf-rh-SM-fsavg.m')
saveas(MeanALFFfig, '/Users/mszkcn/BrainStates_Test/Surface/Graphs/Smoothed/fALFF/MeanfALFF-surf-rh-SM-fsavg.png')
