...
b = bar(y, 'grouped');
title('fALFF (Left Hemisphere, Fsaverage)', 'FontSize', 20, 'FontWeight', 'bold')
...
saveas(b, '/Users/mszkcn/BrainStates_Test/Surface/Graphs/fALFF/surf-fALFF-lhfsavg-Single_Graph.m')
saveas(gcf, '/Users/mszkcn/BrainStates_Test/Surface/Graphs/fALFF/surf-fALFF-lhfsavg-Single_Graph.jpg')
...
b = bar(y, 'grouped');
title('fALFF (Right Hemisphere, Fsaverage)', 'FontSize', 20, 'FontWeight', 'bold')
xlabel('Brain Region', 'FontSize', 15, 'FontWeight', 'bold')
xticklabels({'AC', 'HG', 'PT', 'V1'})
ylabel('fALFF', 'FontSize', 15, 'FontWeight', 'bold')
b(1).FaceColor = [0 0 1]
...
lg = legend('show', {'Auditory Stimulus', 'No Stimulus', 'Visual Stimulus'}, 'FontSize', 12, 'Location', 'southoutside');
set(gcf,'position',[0 100 1000 800]);
saveas(b, '/Users/mszkcn/BrainStates_Test/Surface/Graphs/fALFF/surf-fALFF-rhfsavg-Single_Graph.m')
saveas(gcf, '/Users/mszkcn/BrainStates_Test/Surface/Graphs/fALFF/surf-fALFF-rhfsavg-Single_Graph.jpg')
