...
for c in ${cond[@]}; do
 for r in `cat ${mask_path}/Region_List.txt`; do
    ...
    cat ${ALFF_path}/${r}/sub-01/Mean/sub-01-${c}-${r}-meanALFF.txt ${ALFF_path}/${r}/sub-02/Mean/sub-02-${c}-${r}-meanALFF.txt ${ALFF_path}/${r}/sub-03/Mean/sub-03-${c}-${r}-meanALFF.txt ${ALFF_path}/${r}/sub-04/Mean/sub-04-${c}-${r}-meanALFF.txt ${ALFF_path}/${r}/sub-05/Mean/sub-05-${c}-${r}-meanALFF.txt ${ALFF_path}/${r}/sub-06/Mean/sub-06-${c}-${r}-meanALFF.txt ${ALFF_path}/${r}/sub-07/Mean/sub-07-${c}-${r}-meanALFF.txt ${ALFF_path}/${r}/sub-08/Mean/sub-08-${c}-${r}-meanALFF.txt ${ALFF_path}/${r}/sub-09/Mean/sub-09-${c}-${r}-meanALFF.txt ${ALFF_path}/${r}/sub-10/Mean/sub-10-${c}-${r}-meanALFF.txt ${ALFF_path}/${r}/sub-11/Mean/sub-11-${c}-${r}-meanALFF.txt > ${ALFF_path}/${r}/allsubs-${c}-${r}-meanALFF.txt
    ...
    cat ${alt_ALFF}/${r}/sub-01/sub-01-${c}-${r}-MTS-ALFF.txt ${alt_ALFF}/${r}/sub-02/sub-02-${c}-${r}-MTS-ALFF.txt ${alt_ALFF}/${r}/sub-03/sub-03-${c}-${r}-MTS-ALFF.txt ${alt_ALFF}/${r}/sub-04/sub-04-${c}-${r}-MTS-ALFF.txt ${alt_ALFF}/${r}/sub-05/sub-05-${c}-${r}-MTS-ALFF.txt ${alt_ALFF}/${r}/sub-06/sub-06-${c}-${r}-MTS-ALFF.txt ${alt_ALFF}/${r}/sub-07/sub-07-${c}-${r}-MTS-ALFF.txt ${alt_ALFF}/${r}/sub-08/sub-08-${c}-${r}-MTS-ALFF.txt ${alt_ALFF}/${r}/sub-09/sub-09-${c}-${r}-MTS-ALFF.txt ${alt_ALFF}/${r}/sub-10/sub-10-${c}-${r}-MTS-ALFF.txt ${alt_ALFF}/${r}/sub-11/sub-11-${c}-${r}-MTS-ALFF.txt > ${alt_ALFF}/${r}/allsubs-${c}-${r}-MTS-ALFF.txt
        ...
        for h in ${hemi[@]}; do
           ...
           cat ${ALFF_path}/${r}/sub-01/Mean/sub-01-${c}-${r}-${h}-meanALFF.txt ${ALFF_path}/${r}/sub-02/Mean/sub-02-${c}-${r}-${h}-meanALFF.txt ${ALFF_path}/${r}/sub-03/Mean/sub-03-${c}-${r}-${h}-meanALFF.txt ${ALFF_path}/${r}/sub-04/Mean/sub-04-${c}-${r}-${h}-meanALFF.txt ${ALFF_path}/${r}/sub-05/Mean/sub-05-${c}-${r}-${h}-meanALFF.txt ${ALFF_path}/${r}/sub-06/Mean/sub-06-${c}-${r}-${h}-meanALFF.txt ${ALFF_path}/${r}/sub-07/Mean/sub-07-${c}-${r}-${h}-meanALFF.txt ${ALFF_path}/${r}/sub-08/Mean/sub-08-${c}-${r}-${h}-meanALFF.txt ${ALFF_path}/${r}/sub-09/Mean/sub-09-${c}-${r}-${h}-meanALFF.txt ${ALFF_path}/${r}/sub-10/Mean/sub-10-${c}-${r}-${h}-meanALFF.txt ${ALFF_path}/${r}/sub-11/Mean/sub-11-${c}-${r}-${h}-meanALFF.txt >
